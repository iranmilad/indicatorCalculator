...
class IndicatorUpdate(threading.Thread):
    ...
    def update_key(self,symbol,symbols_return):
        ...
        val = (
            float(symbols_return['adx']['value']['adx_positive']) if not math.isnan(symbols_return['adx']['value']['adx_positive']) else 0,
            float(symbols_return['adx']['value']['adx_negative']) if not math.isnan(symbols_return['adx']['value']['adx_negative']) else 0,
            
            float(symbols_return['ichimoku']['value']['ichimoku_a']) if not math.isnan(symbols_return['ichimoku']['value']['ichimoku_a']) else 0,
            ...
            float(symbols_return['rsi']['value']['RSI']) if not math.isnan(symbols_return['rsi']['value']['RSI']) else 0,
            float(symbols_return['macd']['value']['MACD-Histogram']) if not math.isnan(symbols_return['macd']['value']['MACD-Histogram']) else 0,
            float(symbols_return['uo']['value']['uo']) if not math.isnan(symbols_return['uo']['value']['uo']) else 0, 
            float(symbols_return['roc']['value']['roc']) if not math.isnan(symbols_return['roc']['value']['roc']) else 0,
            float(symbols_return['ema-10']['value']) if not math.isnan(symbols_return['ema-10']['value']) else 0,
            float(symbols_return['ema-20']['value']) if not math.isnan(symbols_return['ema-20']['value']) else 0,
            float(symbols_return['ema-50']['value']) if not math.isnan(symbols_return['ema-50']['value']) else 0,
            float(symbols_return['ema-100']['value']) if not math.isnan(symbols_return['ema-100']['value']) else 0,
            float(symbols_return['ema-200']['value']) if not math.isnan(symbols_return['ema-200']['value']) else 0, 
            float(symbols_return['sma-10']['value']) if not math.isnan(symbols_return['sma-10']['value']) else 0,
            float(symbols_return['sma-20']['value']) if not math.isnan(symbols_return['sma-20']['value']) else 0,
            float(symbols_return['sma-50']['value']) if not math.isnan(symbols_return['sma-50']['value']) else 0,
            float(symbols_return['sma-100']['value']) if not math.isnan(symbols_return['sma-100']['value']) else 0,
            float(symbols_return['sma-200']['value']) if not math.isnan(symbols_return['sma-200']['value']) else 0, 
            float(symbols_return['stoch']['value']['stoch']) if not math.isnan(symbols_return['stoch']['value']['stoch']) else 0, 
            float(symbols_return['adx']['value']['adx']) if not math.isnan(symbols_return['adx']['value']['adx']) else 0, 
            float(symbols_return['cci-20']['value']['cci-20'])  if not math.isnan(symbols_return['cci-20']['value']['cci-20']) else 0, 
            ...
            float(symbols_return['stoch-rsi']['value']['stoch-rsi']) if not math.isnan(symbols_return['stoch-rsi']['value']['stoch-rsi']) else 0, 
            float(symbols_return['williams']['value']['williams']) if not math.isnan(symbols_return['williams']['value']['williams']) else 0,
            float(symbols_return['atr-14']['value']['atr-14']) if not math.isnan(symbols_return['atr-14']['value']['atr-14']) else 0, 
            float(symbols_return['money-flow-index']['value']['MFI']) if not math.isnan(symbols_return['money-flow-index']['value']['MFI']) else 0,
            symbol
        )
